        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-gray mt-12 space-y-10">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">{t("s2intro")}</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li><strong className="text-gray-900">{t("s2li1bold")}</strong> {t("s2li1")}</li>
                <li><strong className="text-gray-900">{t("s2li2bold")}</strong> {t("s2li2")}</li>
                <li><strong className="text-gray-900">{t("s2li3bold")}</strong> {t("s2li3")}</li>
                <li><strong className="text-gray-900">{t("s2li4bold")}</strong> {t("s2li4")}</li>
              </ul>
            </section>
