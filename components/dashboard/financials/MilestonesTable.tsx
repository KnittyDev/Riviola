...
function formatAmount(value: number, currency: string, locale: string) {
  ...
  const lang = locale === "tr" ? "tr-TR" : locale === "sr" ? "sr-RS" : locale === "sq" ? "sq-AL" : locale === "pl" ? "pl-PL" : "en-US";
...
function formatDueDate(dateStr: string | null, locale: string) {
  if (!dateStr) return "—";
  try {
    const lang = locale === "tr" ? "tr-TR" : locale === "sr" ? "sr-RS" : locale === "sq" ? "sq-AL" : locale === "pl" ? "pl-PL" : "en-GB";
