...
const tiers = [
  {
    name: "Essence",
    description: "For boutique developers managing up to 5 sites.",
    monthlyPrice: 109,
    features: [
      "5 Active Projects",
      "720p Live Streams",
  ...
  {
    name: "Signature",
    description: "Scaling infrastructure firms with multiple concurrent sites.",
    monthlyPrice: 199,
    features: [
      "15 Active Projects",
  ...
  {
    name: "Ultra Deluxe",
    description: "Customized solutions for REITs and global contractors.",
    monthlyPrice: 249,
    features: [
      "Unlimited Projects",
...
export function PricingSection() {
  ...
  return (
    <section className="py-32 bg-white overflow-hidden" id="pricing">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {tiers.map((tier) => {
            ...
            <div
              key={tier.name}
              className={`p-8 rounded-[32px] border transition-all relative ${
                tier.recommended
